...
import "./GELECEKGYOAS.sol";

contract GELECEKGYOASPreSale {
    GELECEKGYOAS public token;
    address public beneficiary;
    uint public amountRaised;
    uint public bonus;

    uint constant public price = 10000000;
    uint constant public minSaleAmount = 100000;

    function GELECEKGYOASPreSale(
        GELECEKGYOAS _token,
        address _beneficiary,
        uint _bonus
    ) {
        token = GELECEKGYOAS(_token);
